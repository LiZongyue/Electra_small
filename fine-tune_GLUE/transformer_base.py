...
class BaseTransformer(pl.LightningModule):
    def __init__(self, hparams: argparse.Namespace, num_labels=None, mode="base", **config_kwargs):
        ...
        '''
        self.config = ElectraConfig(embedding_size=64,
                                    hidden_size=128,
                                    num_hidden_layers=6,
        ...
        self.model = ElectraForPreTraining(self.config)

        self.model.load_state_dict(torch.load(self.hparams.model_name_or_path))

        '''MODEL_MODES[mode].from_pretrained(
